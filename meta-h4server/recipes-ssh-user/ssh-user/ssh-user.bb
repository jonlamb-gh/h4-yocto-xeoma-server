...
USERADD_PACKAGES = "${PN}"
USERADD_PARAM:${PN} = "--uid 1201 --home-dir /home/me --create-home --shell /bin/sh --password '*' me"

USER="me"

FILES:${PN} = "/home/${USER}/.ssh/authorized_keys /home/${USER}/.ssh/id_rsa /home/${USER}/.ssh/id_rsa.pub"
